...
dgApp.controller('mainController', function($scope) {
    console.log('this is the main controller.');
});

dgApp.controller('aboutController', function($scope) {
    console.log('this is the about controller.');
});


dgApp.controller('regController', function($scope, $http, $location, $cookies) {
...
dgApp.controller('loginController', function($scope, $http, $location, $cookies) {
...
dgApp.controller('optionsCtrl', function($scope, $http, $location, $cookies) {
...
dgApp.controller('deliveryCtrl', function($scope, $http, $location, $cookies) {
...
dgApp.controller('checkoutCtrl', function($scope, $http, $location, $cookies) {
...
dgApp.controller('receiptCtrl', function($scope) {
